...
enum KernelABIRuntimeValidator {
    ...
    static func validate() -> [Mismatch] {
        ...
        check("omniwm_niri_topology_input", omniwm_niri_topology_input.self, expected: KernelABISchemaEntry(name: "omniwm_niri_topology_input", size: 160, stride: 160, alignment: 8), into: &mismatches)
        ...
        check("omniwm_orchestration_window_removal_payload", omniwm_orchestration_window_removal_payload.self, expected: KernelABISchemaEntry(name: "omniwm_orchestration_window_removal_payload", size: 80, stride: 80, alignment: 8), into: &mismatches)
